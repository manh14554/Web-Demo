const productsData = {
    "balo": {
        ...
        desc: "Carry all the things with the sleek, streamlines Sly Pack. It features a roomy main compartment, a front zip pocket for your smaller items, and a mesh water bottle holder on the side.",
        price: "$29.99",
    ...
    "ao": {
        ...
        desc: "Rip snap infant onesie for the junior automation engineer in development. Reinforced 3-snap bottom closure, two-needle hemmed sleeved and bottom won't unravel.",
        price: "$19.99",
        image: "./images/ao.png"
    }
};
